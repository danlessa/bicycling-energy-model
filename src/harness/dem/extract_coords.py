...
Usage: python3 src/harness/dem/extract_coords.py [OUTDIR] [STEP]
       OUTDIR defaults to src/harness/dem/coords/ (gitignored — per-ride GPS)
...
ACT = os.path.join(REPO, "data", "inputs", "activities")
