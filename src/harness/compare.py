...
report). The engines and parsers come from src/bicycling_energy_model — the
line-by-line port of the app's JS (its JS-parity check is retired; git
history keeps analysis/parity/).

Reads data/inputs/activities/model_inputs.json (+ the gitignored tracks); writes
...
from bicycling_energy_model import (approximate, ascent_hyst, build_profile, canonical,
                                    climb_balance, deadband, empirical_kj, eps_from_balance,
                                    extract_regime_powers, flat_eq_speed, is_finite, load_pts,
                                    measured_flat_speed, overall_mean_power, resample_profile)
from bicycling_energy_model.engines import G
from bicycling_energy_model.jsfmt import to_exponential, to_fixed
