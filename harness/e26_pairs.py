...
results/igc_resolution_test.csv includes: censo + ppaz + jaam + danlessa inside
...
Corpus membership comes from results/igc_resolution_test.csv (regenerable via
harness/igc_resolution_test.py) so this list is exactly Entry 19's funnel; each
...
repo locally only). stdout is aggregates only, NO coordinates and no ride names.
  ...
  /Users/danlessa/conda/bin/python harness/e26_pairs.py
"""
