...
//
// Output: console report + danlessa_comparison.csv (gitignored via results/*).
...
// ===== driver =====
const man = JSON.parse(fs.readFileSync(path.join(DATA, 'strava_danlessa_manifest.json'), 'utf8'));
...
fs.writeFileSync(path.join(RESULTS, 'danlessa_comparison.csv'), csv + '\n');
