...
//
// Output: console report + jaam_comparison.csv (gitignored via results/*).
...
// ===== driver =====
const man = JSON.parse(fs.readFileSync(path.join(DATA, 'strava_jaam_manifest.json'), 'utf8'));
...
fs.writeFileSync(path.join(RESULTS, 'jaam_comparison.csv'), csv + '\n');
