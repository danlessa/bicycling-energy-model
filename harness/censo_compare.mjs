...
//
// Engines ported verbatim from applet/index.html / compare.mjs.
...
fs.writeFileSync(path.join(RESULTS, 'censo_comparison.csv'),
...
console.log(`\nwrote results/censo_comparison.csv (${rows.length} rides)`);
