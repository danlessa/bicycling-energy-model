...
- **Entry 23** (literature review: cumulative-ascent error of consumer barometers vs DEMs,
  positioned against Entries 6/19–21,
  [`ascent-error-literature.md`](ascent-error-literature.md)) — this commit

---

## 2026-07-12 — Entry 23: what the literature says a cumulative-ascent measurement is worth — and why our energy endpoint can decide what geometry cannot
