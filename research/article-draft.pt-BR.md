...
Todas as gravações de potência e GPS analisadas aqui foram feitas pelo autor, no dispositivo do próprio autor, inclusive em pedaladas em grupo; nenhum dado fisiológico ou de localização de terceiros é usado ou publicado. Atividades gravadas por outros ciclistas (16 dos links do censo) foram excluídas em vez de acessadas. O histórico do repositório foi auditado quanto a vazamento de dados pessoais; trilhas brutas e planilhas são excluídas do controle de versão.
