...
1. **Elevação.** Use uma fonte de terreno nu com amostragem *bilinear* ao longo da trilha — FABDEM × `k_DEM ≈ 0,95` chega a ~5% da verdade de levantamento de 5 m (§8.7). Nunca amostre por vizinho-mais-próximo: adiciona ~30 pontos de subida espúria.
