...
- **Avaliação contra um `ε` de balanço de energia na descida medido por potência**: uma redução de 37% no RMS sobre a melhor constante fixa em descidas reais (s̄ ≥ 3%, n = 22), com correlações de 0,30–0,82 conforme a ponderação e o subconjunto (intra-amostra; a §8.3 declara as ressalvas e o exemplo resolvido por completo).
