...
**Table 5.** In-sample validation at scale (D5, the author's 621 clean rides): median $\lvert\Delta\%\rvert$ [95% CI] and median signed $\Delta\%$, frozen constants throughout. (Signed medians print with ties-away rounding; the simulation's exact signed median is +0.05.)
