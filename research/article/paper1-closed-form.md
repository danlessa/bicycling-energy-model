...
1. **A hand-computable route-energy law.** The three-term form $E = \alpha_r\,x + \alpha_a\,x_{\mathrm{flat}} + \beta\,(\tilde h_+ - \varepsilon\,\tilde h_-)$ and its totals-only approximation (F4), derived from the route-energy integral ([Appendix A](#appendix-a)) and validated against a forward simulation and 2,039 measured rides from seven riders ([§3](#3)).
...
2. **primary comparison** — the closed-form-vs-simulation contest of [§3.3](#3.3); because it shares the calibration corpus, it can support only parity-where-derived — which is what roles 3–6 exist to extend;
