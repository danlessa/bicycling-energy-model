...
Usage: python3 research/scripts/make_claims_explorer.py
"""
...
NOTES = os.path.abspath(os.path.join(HERE, "..", "notes"))
TTL = os.path.join(NOTES, "claims.ttl")
OUT = os.path.join(NOTES, "claims-explorer.html")
